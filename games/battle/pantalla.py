import math #math es para matemáticas operaciones
import random #random numeros aleatorios
import numpy as np
import pygame
...
pygame.mixer.init() #este inicializa pygame importante...
...
playerImg = pygame.image.load('tanque.png') #player imagen
...
bulletImg = pygame.image.load('bullet.png') #imagen del disparo
